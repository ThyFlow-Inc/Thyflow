        ...
        <div className="d-md-flex">
          <div className="w3ls_banner_txt">
            ...
            <p className="text-sty-banner">
              ThyFlow is a trusted platform for anyone to find verified Mobile
              Service providers in their local area and book an appointment. We
              connect service providers with customers that need and want their
              service, in a safe and secure manner.
            </p>
            <div className="row">
              <a
                href="https://www.thyflow.com"
                target="_blank"
